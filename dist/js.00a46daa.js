...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/plugins-init.js":[function(require,module,exports) {
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/vendor/gsap.min.js":[function(require,module,exports) {
var define;
...
function preloader() {
  ...
  pl.to('.preloader__content__circle-anime', {
    scale: 150
  });
  pl.to('.preloader', {
    opacity: 0,
...
;
window.addEventListener('load', preloader); // Navigation Animation 
...
nav.to('.header__content__mobile-nav', {
  opacity: 1,
  visibility: 'visible',
  zIndex: 10
});
nav.to('.header__content__toggle-mobile', {
  border: '1px solid #fff'
});
nav.to('.line', {
  border: '1px solid #fff'
});
nav.to('.menu__list-item', {
  opacity: 1,
  stagger: 0.2,
  marginLeft: 0
});
...
var _pluginsInit = _interopRequireDefault(require("./plugins-init"));

var _main = _interopRequireDefault(require("../css/main/main"));

var _gsap = _interopRequireDefault(require("./vendor/gsap.min"));

var _app = _interopRequireDefault(require("./app"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./plugins-init":"js/plugins-init.js","../css/main/main":"css/main/main.scss","./vendor/gsap.min":"js/vendor/gsap.min.js","./app":"js/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
